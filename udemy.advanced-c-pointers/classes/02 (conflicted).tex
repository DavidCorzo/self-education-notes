...
\begin{itemize}
    ...
    \item Sometimes the data types are different sizes on different machines, for example on a PC the size of the long int is 4 and on a mac it is 8 bytes. This is why its better to have the \mintinline{cpp}{+= 1}
\end{itemize}
