...
\begin{itemize}
    \item The debugger is a general solution to all problems with c code. It allows us to see code execution step by step and see where it fails in order to correct it.
    \item See the followign example:
        \begin{figure}[H]
            \centering
            \includegraphics[width=\width\textwidth]{./figs/20221027214228.png}
            %\caption{}
        \end{figure}
        \begin{itemize}
            \item In all the red dots the program execution will stop, this means that you can see the state of the program and possibly spot the problem. The red dot is called a break point.
        \end{itemize}
    
    \item When a breakpoint stops program execution you can see the local variables and their values in a panel such as this:
        \begin{figure}[H]
            \centering
            \includegraphics[width=\width\textwidth]{./figs/20221027214418.png}
            %\caption{}
        \end{figure}
    
    \item You also have a console in which you can type names of variables and it will print the value of the variable in that moment in execution.
        \begin{figure}[H]
            \centering
            \includegraphics[width=\width\textwidth]{./figs/20221027214549.png}
            %\caption{}
        \end{figure}
\end{itemize}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Debugging Multiple Indirection}
\begin{itemize}
    \item Multiple indirection is whenever you dereference a pointer and the dereferenced pointer is another pointer, thus you need to dereference it again to get the value, sometimes its a tripple pointer and you need to dereference 3 times. Multiple indirection is in general whenever you need to dereference something more than once.
    ...
    \item Using a memory detail window in visual studio we can see the individual cells in memory which is very handy for this example:
        \begin{itemize}
            \item See the following code:
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=\width\textwidth]{./figs/20221027215600.png}
                    %\caption{}
                \end{figure}
            
            \item We can see these values reflected here in memory:
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=\width\textwidth]{./figs/20221027220000.png}
                    %\caption{}
                \end{figure}
            
            \item Notice that all the pointers point to the integer, the difference is that they are chained, one references the other like so:
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=\width\textwidth]{./figs/20221027220113.png}
                    \includegraphics[width=\width\textwidth]{./figs/20221027220131.png}
                    \includegraphics[width=\width\textwidth]{./figs/20221027220152.png}
                    %\caption{}
                \end{figure}
            
            \item We eventually arrive to the value here.
        \end{itemize}
\end{itemize}