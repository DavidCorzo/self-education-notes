...
\begin{itemize}
    ...
    \item So on windows: Options $\displaystyle >$ preferences $\displaystyle >$ Link Tempo Midi (plug in the midi device):
        \begin{figure}[H]
            \centering
            \includegraphics[width=\width\textwidth]{./figs/20220612195322.png}
            \includegraphics[width=\width\textwidth]{./figs/20220612195338.png}
            \includegraphics[width=\width\textwidth]{./figs/20220612195416.png}
            %\caption{}
        \end{figure}
        \begin{itemize}
            \item Make sure all the midi ports are marked in the column where it says Track.
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=\width\textwidth]{./figs/20220612195508.png}
                    %\caption{}
                \end{figure}
        \end{itemize}
    
    \item Now we return to our track. You should be able to hear your midi device's midi signals. If you don't make sure the monitor is set to auto:
        \begin{figure}[H]
            \centering
            \includegraphics[width=\width\textwidth]{./figs/20220612195600.png}
            %\caption{}
        \end{figure}
\end{itemize}

\subsection{Unrecognized midi keyboards}
\begin{itemize}
    \item Sometimes when you connect your midi keyboard to ableton it won't show up in the control surface. If that is the case just make sure the Track is selected for the midi device and you should be able to hear:
        \begin{figure}[H]
            \centering
            \includegraphics[width=\width\textwidth]{./figs/20220612195847.png}
            %\caption{}
        \end{figure}
\end{itemize}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The basics of writing midi}
\begin{itemize}
    \item The midi space is divided in 4/4 time:
        \begin{figure}[H]
            \centering
            \includegraphics[width=\width\textwidth]{./figs/20220612200226.png}
            %\caption{}
        \end{figure}
    
    \item To hear the pitch you can press the following:
        \begin{figure}[H]
            \centering
            \includegraphics[width=\width\textwidth]{./figs/20220612200307.png}
            %\caption{}
        \end{figure}
    
    \item To change the pitch click and drag up and down, to alongate or shorten or reposition in time the note drag and extend or reposition accordingly.
    \item When making music the midis are commonly worked as 4 to 8 bar loops. In other words 8 metronome clicks.
    \item To extend the loop you can edit the length here:
        \begin{figure}[H]
            \centering
            \includegraphics[width=\width\textwidth]{./figs/20220612200514.png}
            %\caption{}
        \end{figure}
    
    \item The + key will zoom in and - will zoom out. To zoom vertically you can push alt and then scroll your mouse.
    \item By pressing shift and the note and dragging it it duplicates the note.
    \item To undo changes to the midi you can press ctr+shift+z.
\end{itemize}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Writing a new part (velocity, scale)}
\begin{itemize}
    \item 
\end{itemize}